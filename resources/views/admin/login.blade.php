        ...
        <form action="{{ admin_base_path('auth/login') }}" method="post">
            ...
            <div class="row">
                <div class="form-group has-feedback {!! !$errors->has('captcha') ?: 'has-error' !!}">
                    ...
                    <input type="text" class="form-control" style="display: inline;width: 55%; margin-left: 15px;"  name="captcha">
                    <span class="glyphicon glyphicon-refresh form-control-feedback" style="right:39%;z-index: 100"></span>
